    ...
    public partial class InitialPostgreSqlMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "123 Main St", "john@example.com", "John Doe", "555-0101", 1 },
                    { 2, "456 Oak Ave", "jane@example.com", "Jane Smith", "555-0102", 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "password1", 1, "john@example.com" },
                    { 2, "password1", 2, "jane@example.com" }
                });
